...
"+" - Record a new score that is the sum of the previous two scores. It is guaranteed there
...
"C" - Invalidate the previous score, removing it from the record. It is guaranteed there
